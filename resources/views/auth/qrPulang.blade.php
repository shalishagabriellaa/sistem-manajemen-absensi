    ...
    <div class="clean-qr-container">
        <div class="qr-scanner-card">
            <h1 class="clean-title">
                <i class="fas fa-qrcode" style="margin-right: 0.5rem; color: #ef4444;"></i>
                {{ $title }}
            </h1>
            <p class="clean-subtitle">
                Arahkan kamera ke QR code untuk absen pulang
            </p>
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            if(response == 'pulang'){
                                ...
                                updateStatus('Sudah absen pulang', 'error');
                                Swal.fire({
                                    icon: 'warning',
                                    title: 'Perhatian',
