...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="card">
            <form method="POST" class="p-4" action="{{ url('/project/update/'.$project->id) }}">
                @csrf
                ...
                <div class="form-group mb-3">
                    ...
                    <select class="form-control @error('user_id') is-invalid @enderror" id="user_id" name="user_id">
                        ...
                        @foreach ($user as $us)
                            <option value="{{ $us->id }}" {{ (old('user_id', $project->user_id)) == $us->id ? 'selected' : '' }}>{{ $us->name }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group mb-3">
                    ...
                    <select class="form-control @error('jenis_project') is-invalid @enderror" id="jenis_project" name="jenis_project">
                        <option value="">-- Pilih --</option>
                        @foreach(['Internal','Eksternal','Pemerintah','Swasta'] as $jenis)
                            <option value="{{ $jenis }}" {{ old('jenis_project', $project->jenis_project) == $jenis ? 'selected' : '' }}>{{ $jenis }}</option>
                        @endforeach
                    </select>
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="date" class="form-control @error('tanggal_po') is-invalid @enderror"
                                   id="tanggal_po" name="tanggal_po" value="{{ old('tanggal_po', $project->tanggal_po) }}">
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="date" class="form-control @error('tanggal_kontrak') is-invalid @enderror"
                                   id="tanggal_kontrak" name="tanggal_kontrak" value="{{ old('tanggal_kontrak', $project->tanggal_kontrak) }}">
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control @error('no_po') is-invalid @enderror"
                                   id="no_po" name="no_po" value="{{ old('no_po', $project->no_po) }}">
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control @error('nama_po') is-invalid @enderror"
                                   id="nama_po" name="nama_po" value="{{ old('nama_po', $project->nama_po) }}">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" class="form-control money @error('nilai_po') is-invalid @enderror"
                           id="nilai_po" name="nilai_po" value="{{ old('nilai_po', number_format($project->nilai_po, 0, ',', ',')) }}">
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control @error('no_kontrak') is-invalid @enderror"
                                   id="no_kontrak" name="no_kontrak" value="{{ old('no_kontrak', $project->no_kontrak) }}">
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control @error('nama_kontrak') is-invalid @enderror"
                                   id="nama_kontrak" name="nama_kontrak" value="{{ old('nama_kontrak', $project->nama_kontrak) }}">
                ...
                <div class="form-group mb-3">
                    ...
                    <select class="form-control @error('status') is-invalid @enderror" id="status" name="status">
                        @foreach(['Active','Inactive','Selesai'] as $s)
