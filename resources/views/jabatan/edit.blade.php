...
<div class="card karyawan-card">
    ...
    <form method="post" action="{{ url('/jabatan/update/'.$data_jabatan->id) }}">
        ...
        <div class="form-card">
            ...
            <div class="form-section-label">Edit Informasi Divisi</div>
            ...
            <div class="form-group">
                ...
                <input type="text"
                       ...
                       autofocus value="{{ old('nama_jabatan', $data_jabatan->nama_jabatan) }}">
                @error('nama_jabatan')
            ...
            <div class="form-group">
                ...
                <select class="form-control selectpicker @error('manager') is-invalid @enderror"
                    ...
                    @foreach ($users as $du)
                        <option value="{{ $du->id }}"
                            {{ old('manager', $data_jabatan->manager) == $du->id ? 'selected' : '' }}>
                            {{ $du->name }}
                        </option>
                    @endforeach
                </select>
