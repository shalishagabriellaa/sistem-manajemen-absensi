                    ...
                    <div class="tf-container">
                        ...
                        @if ($shift_karyawan->lock_location == null)
                            <div class="group-input">
                                ...
                                <textarea name="keterangan_masuk" class="@error('keterangan_masuk') is-invalid @enderror" placeholder="Masuk">{{ old('keterangan_masuk', 'Masuk') }}</textarea>
                    ...
                    <div class="tf-container">
                        ...
                        @if ($shift_karyawan->lock_location == null)
                            <div class="group-input">
                                ...
                                <textarea name="keterangan_pulang" class="@error('keterangan_pulang') is-invalid @enderror" placeholder="Pulang">{{ old('keterangan_pulang', 'Pulang') }}</textarea>
